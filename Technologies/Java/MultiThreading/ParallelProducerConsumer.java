 ...
 *Please write a program that does the following:
  ...
  The program should run until the Producer produces 100 numbers. The Producer and Consumer should be running in parallel, in other words, the Consumer should be able to consume numbers before the Producer is done producing all 100 numbers.
 */
